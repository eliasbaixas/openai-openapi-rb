...
# Unit tests for OpenAi::ChatCompletionStreamResponseDelta
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAi::ChatCompletionStreamResponseDelta do
  let(:instance) { OpenAi::ChatCompletionStreamResponseDelta.new }
  ...
  describe 'test an instance of ChatCompletionStreamResponseDelta' do
    it 'should create an instance of ChatCompletionStreamResponseDelta' do
      ...
      #expect(instance).to be_instance_of(OpenAi::ChatCompletionStreamResponseDelta)
    end
  end
