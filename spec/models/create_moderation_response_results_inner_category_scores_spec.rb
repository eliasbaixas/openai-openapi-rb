...
# Unit tests for OpenAi::CreateModerationResponseResultsInnerCategoryScores
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAi::CreateModerationResponseResultsInnerCategoryScores do
  let(:instance) { OpenAi::CreateModerationResponseResultsInnerCategoryScores.new }
  ...
  describe 'test an instance of CreateModerationResponseResultsInnerCategoryScores' do
    it 'should create an instance of CreateModerationResponseResultsInnerCategoryScores' do
      ...
      #expect(instance).to be_instance_of(OpenAi::CreateModerationResponseResultsInnerCategoryScores)
    end
  end
