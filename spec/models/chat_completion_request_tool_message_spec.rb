...
# Unit tests for OpenAi::ChatCompletionRequestToolMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAi::ChatCompletionRequestToolMessage do
  let(:instance) { OpenAi::ChatCompletionRequestToolMessage.new }
  ...
  describe 'test an instance of ChatCompletionRequestToolMessage' do
    it 'should create an instance of ChatCompletionRequestToolMessage' do
      ...
      #expect(instance).to be_instance_of(OpenAi::ChatCompletionRequestToolMessage)
    end
  end
