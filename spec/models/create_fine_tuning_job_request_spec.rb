...
# Unit tests for OpenaiOpenapiRb::CreateFineTuningJobRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenaiOpenapiRb::CreateFineTuningJobRequest do
  let(:instance) { OpenaiOpenapiRb::CreateFineTuningJobRequest.new }
  ...
  describe 'test an instance of CreateFineTuningJobRequest' do
    it 'should create an instance of CreateFineTuningJobRequest' do
      ...
      #expect(instance).to be_instance_of(OpenaiOpenapiRb::CreateFineTuningJobRequest)
    end
  end
