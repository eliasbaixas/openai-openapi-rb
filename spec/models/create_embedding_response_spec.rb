...
# Unit tests for OpenaiOpenapiRb::CreateEmbeddingResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenaiOpenapiRb::CreateEmbeddingResponse do
  let(:instance) { OpenaiOpenapiRb::CreateEmbeddingResponse.new }
  ...
  describe 'test an instance of CreateEmbeddingResponse' do
    it 'should create an instance of CreateEmbeddingResponse' do
      ...
      #expect(instance).to be_instance_of(OpenaiOpenapiRb::CreateEmbeddingResponse)
    end
  end
