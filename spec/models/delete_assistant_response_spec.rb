...
# Unit tests for OpenAI::API::DeleteAssistantResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAI::API::DeleteAssistantResponse do
  let(:instance) { OpenAI::API::DeleteAssistantResponse.new }
  ...
  describe 'test an instance of DeleteAssistantResponse' do
    it 'should create an instance of DeleteAssistantResponse' do
      ...
      #expect(instance).to be_instance_of(OpenAI::API::DeleteAssistantResponse)
    end
  end
