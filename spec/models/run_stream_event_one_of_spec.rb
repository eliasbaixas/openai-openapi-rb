...
# Unit tests for OpenAi::RunStreamEventOneOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAi::RunStreamEventOneOf do
  let(:instance) { OpenAi::RunStreamEventOneOf.new }

  describe 'test an instance of RunStreamEventOneOf' do
    it 'should create an instance of RunStreamEventOneOf' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenAi::RunStreamEventOneOf)
    end
  end
