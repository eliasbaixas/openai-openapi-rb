...
# Unit tests for OpenaiOpenapiRb::CreateEditResponseChoicesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenaiOpenapiRb::CreateEditResponseChoicesInner do
  let(:instance) { OpenaiOpenapiRb::CreateEditResponseChoicesInner.new }
  ...
  describe 'test an instance of CreateEditResponseChoicesInner' do
    it 'should create an instance of CreateEditResponseChoicesInner' do
      ...
      #expect(instance).to be_instance_of(OpenaiOpenapiRb::CreateEditResponseChoicesInner)
    end
  end
