...
# Unit tests for OpenAI::API::CreateEmbeddingRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAI::API::CreateEmbeddingRequest do
  let(:instance) { OpenAI::API::CreateEmbeddingRequest.new }

  describe 'test an instance of CreateEmbeddingRequest' do
    it 'should create an instance of CreateEmbeddingRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenAI::API::CreateEmbeddingRequest)
    end
  end
