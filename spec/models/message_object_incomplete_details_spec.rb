...
# Unit tests for OpenAi::MessageObjectIncompleteDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAi::MessageObjectIncompleteDetails do
  let(:instance) { OpenAi::MessageObjectIncompleteDetails.new }
  ...
  describe 'test an instance of MessageObjectIncompleteDetails' do
    it 'should create an instance of MessageObjectIncompleteDetails' do
      ...
      #expect(instance).to be_instance_of(OpenAi::MessageObjectIncompleteDetails)
    end
  end
