...
# Unit tests for OpenAi::RunStepDetailsMessageCreationObject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAi::RunStepDetailsMessageCreationObject do
  let(:instance) { OpenAi::RunStepDetailsMessageCreationObject.new }
  ...
  describe 'test an instance of RunStepDetailsMessageCreationObject' do
    it 'should create an instance of RunStepDetailsMessageCreationObject' do
      ...
      #expect(instance).to be_instance_of(OpenAi::RunStepDetailsMessageCreationObject)
    end
  end
