...
# Unit tests for OpenaiOpenapiRb::FineTuningJobEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenaiOpenapiRb::FineTuningJobEvent do
  let(:instance) { OpenaiOpenapiRb::FineTuningJobEvent.new }

  describe 'test an instance of FineTuningJobEvent' do
    it 'should create an instance of FineTuningJobEvent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenaiOpenapiRb::FineTuningJobEvent)
    end
  end
