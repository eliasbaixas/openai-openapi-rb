...
# Unit tests for OpenAI::API::CreateEditRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAI::API::CreateEditRequest do
  let(:instance) { OpenAI::API::CreateEditRequest.new }

  describe 'test an instance of CreateEditRequest' do
    it 'should create an instance of CreateEditRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenAI::API::CreateEditRequest)
    end
  end
