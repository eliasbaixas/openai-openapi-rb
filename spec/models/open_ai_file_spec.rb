...
# Unit tests for OpenAI::API::OpenAIFile
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAI::API::OpenAIFile do
  let(:instance) { OpenAI::API::OpenAIFile.new }

  describe 'test an instance of OpenAIFile' do
    it 'should create an instance of OpenAIFile' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenAI::API::OpenAIFile)
    end
  end
