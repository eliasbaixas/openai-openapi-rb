...
# Unit tests for OpenAi::UserListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAi::UserListResponse do
  let(:instance) { OpenAi::UserListResponse.new }

  describe 'test an instance of UserListResponse' do
    it 'should create an instance of UserListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenAi::UserListResponse)
    end
  end
