...
# Unit tests for OpenaiOpenapiRb::ChatCompletionResponseMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenaiOpenapiRb::ChatCompletionResponseMessage do
  let(:instance) { OpenaiOpenapiRb::ChatCompletionResponseMessage.new }
  ...
  describe 'test an instance of ChatCompletionResponseMessage' do
    it 'should create an instance of ChatCompletionResponseMessage' do
      ...
      #expect(instance).to be_instance_of(OpenaiOpenapiRb::ChatCompletionResponseMessage)
    end
  end
