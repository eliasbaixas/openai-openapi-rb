...
# Unit tests for OpenAi::RunStepDetailsToolCallsObject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAi::RunStepDetailsToolCallsObject do
  let(:instance) { OpenAi::RunStepDetailsToolCallsObject.new }
  ...
  describe 'test an instance of RunStepDetailsToolCallsObject' do
    it 'should create an instance of RunStepDetailsToolCallsObject' do
      ...
      #expect(instance).to be_instance_of(OpenAi::RunStepDetailsToolCallsObject)
    end
  end
