...
# Unit tests for OpenAI::API::CreateChatCompletionStreamResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAI::API::CreateChatCompletionStreamResponse do
  let(:instance) { OpenAI::API::CreateChatCompletionStreamResponse.new }
  ...
  describe 'test an instance of CreateChatCompletionStreamResponse' do
    it 'should create an instance of CreateChatCompletionStreamResponse' do
      ...
      #expect(instance).to be_instance_of(OpenAI::API::CreateChatCompletionStreamResponse)
    end
  end
