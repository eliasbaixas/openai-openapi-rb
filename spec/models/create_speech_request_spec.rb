...
# Unit tests for OpenAI::API::CreateSpeechRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAI::API::CreateSpeechRequest do
  let(:instance) { OpenAI::API::CreateSpeechRequest.new }

  describe 'test an instance of CreateSpeechRequest' do
    it 'should create an instance of CreateSpeechRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenAI::API::CreateSpeechRequest)
    end
  end
