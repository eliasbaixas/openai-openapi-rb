...
# Unit tests for OpenAI::API::CreateChatCompletionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAI::API::CreateChatCompletionRequest do
  let(:instance) { OpenAI::API::CreateChatCompletionRequest.new }
  ...
  describe 'test an instance of CreateChatCompletionRequest' do
    it 'should create an instance of CreateChatCompletionRequest' do
      ...
      #expect(instance).to be_instance_of(OpenAI::API::CreateChatCompletionRequest)
    end
  end
