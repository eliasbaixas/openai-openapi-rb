...
# Unit tests for OpenAi::RunCompletionUsage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAi::RunCompletionUsage do
  let(:instance) { OpenAi::RunCompletionUsage.new }

  describe 'test an instance of RunCompletionUsage' do
    it 'should create an instance of RunCompletionUsage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenAi::RunCompletionUsage)
    end
  end
