...
# Unit tests for OpenAi::CreateChatCompletionFunctionResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAi::CreateChatCompletionFunctionResponse do
  let(:instance) { OpenAi::CreateChatCompletionFunctionResponse.new }
  ...
  describe 'test an instance of CreateChatCompletionFunctionResponse' do
    it 'should create an instance of CreateChatCompletionFunctionResponse' do
      ...
      #expect(instance).to be_instance_of(OpenAi::CreateChatCompletionFunctionResponse)
    end
  end
