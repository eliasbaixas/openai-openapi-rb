...
# Unit tests for OpenAi::CreateUploadRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAi::CreateUploadRequest do
  let(:instance) { OpenAi::CreateUploadRequest.new }

  describe 'test an instance of CreateUploadRequest' do
    it 'should create an instance of CreateUploadRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenAi::CreateUploadRequest)
    end
  end
