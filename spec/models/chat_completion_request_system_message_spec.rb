...
# Unit tests for OpenAi::ChatCompletionRequestSystemMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAi::ChatCompletionRequestSystemMessage do
  let(:instance) { OpenAi::ChatCompletionRequestSystemMessage.new }
  ...
  describe 'test an instance of ChatCompletionRequestSystemMessage' do
    it 'should create an instance of ChatCompletionRequestSystemMessage' do
      ...
      #expect(instance).to be_instance_of(OpenAi::ChatCompletionRequestSystemMessage)
    end
  end
