...
# Unit tests for OpenAI::API::CreateFineTuningJobRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAI::API::CreateFineTuningJobRequest do
  let(:instance) { OpenAI::API::CreateFineTuningJobRequest.new }
  ...
  describe 'test an instance of CreateFineTuningJobRequest' do
    it 'should create an instance of CreateFineTuningJobRequest' do
      ...
      #expect(instance).to be_instance_of(OpenAI::API::CreateFineTuningJobRequest)
    end
  end
