...
# Unit tests for OpenAI::API::FineTuningJob
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAI::API::FineTuningJob do
  let(:instance) { OpenAI::API::FineTuningJob.new }

  describe 'test an instance of FineTuningJob' do
    it 'should create an instance of FineTuningJob' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenAI::API::FineTuningJob)
    end
  end
