...
# Unit tests for OpenAi::CreateEditResponseChoicesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAi::CreateEditResponseChoicesInner do
  let(:instance) { OpenAi::CreateEditResponseChoicesInner.new }
  ...
  describe 'test an instance of CreateEditResponseChoicesInner' do
    it 'should create an instance of CreateEditResponseChoicesInner' do
      ...
      #expect(instance).to be_instance_of(OpenAi::CreateEditResponseChoicesInner)
    end
  end
