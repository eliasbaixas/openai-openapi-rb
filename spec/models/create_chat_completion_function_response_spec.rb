...
# Unit tests for OpenAI::API::CreateChatCompletionFunctionResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAI::API::CreateChatCompletionFunctionResponse do
  let(:instance) { OpenAI::API::CreateChatCompletionFunctionResponse.new }
  ...
  describe 'test an instance of CreateChatCompletionFunctionResponse' do
    it 'should create an instance of CreateChatCompletionFunctionResponse' do
      ...
      #expect(instance).to be_instance_of(OpenAI::API::CreateChatCompletionFunctionResponse)
    end
  end
