...
# Unit tests for OpenAI::API::ChatCompletionStreamResponseDelta
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAI::API::ChatCompletionStreamResponseDelta do
  let(:instance) { OpenAI::API::ChatCompletionStreamResponseDelta.new }
  ...
  describe 'test an instance of ChatCompletionStreamResponseDelta' do
    it 'should create an instance of ChatCompletionStreamResponseDelta' do
      ...
      #expect(instance).to be_instance_of(OpenAI::API::ChatCompletionStreamResponseDelta)
    end
  end
