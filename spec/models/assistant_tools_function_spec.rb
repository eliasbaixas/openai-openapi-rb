...
# Unit tests for OpenAi::AssistantToolsFunction
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAi::AssistantToolsFunction do
  let(:instance) { OpenAi::AssistantToolsFunction.new }

  describe 'test an instance of AssistantToolsFunction' do
    it 'should create an instance of AssistantToolsFunction' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenAi::AssistantToolsFunction)
    end
  end
