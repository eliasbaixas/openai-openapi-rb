...
# Unit tests for OpenAi::MessageContentTextAnnotationsFileCitationObject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAi::MessageContentTextAnnotationsFileCitationObject do
  let(:instance) { OpenAi::MessageContentTextAnnotationsFileCitationObject.new }
  ...
  describe 'test an instance of MessageContentTextAnnotationsFileCitationObject' do
    it 'should create an instance of MessageContentTextAnnotationsFileCitationObject' do
      ...
      #expect(instance).to be_instance_of(OpenAi::MessageContentTextAnnotationsFileCitationObject)
    end
  end
