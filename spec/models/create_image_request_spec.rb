...
# Unit tests for OpenAI::API::CreateImageRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAI::API::CreateImageRequest do
  let(:instance) { OpenAI::API::CreateImageRequest.new }

  describe 'test an instance of CreateImageRequest' do
    it 'should create an instance of CreateImageRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenAI::API::CreateImageRequest)
    end
  end
