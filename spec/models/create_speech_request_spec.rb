...
# Unit tests for OpenAi::CreateSpeechRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAi::CreateSpeechRequest do
  let(:instance) { OpenAi::CreateSpeechRequest.new }

  describe 'test an instance of CreateSpeechRequest' do
    it 'should create an instance of CreateSpeechRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenAi::CreateSpeechRequest)
    end
  end
