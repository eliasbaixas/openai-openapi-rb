...
# Unit tests for OpenaiOpenapiRb::ChatCompletionStreamResponseDelta
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenaiOpenapiRb::ChatCompletionStreamResponseDelta do
  let(:instance) { OpenaiOpenapiRb::ChatCompletionStreamResponseDelta.new }
  ...
  describe 'test an instance of ChatCompletionStreamResponseDelta' do
    it 'should create an instance of ChatCompletionStreamResponseDelta' do
      ...
      #expect(instance).to be_instance_of(OpenaiOpenapiRb::ChatCompletionStreamResponseDelta)
    end
  end
