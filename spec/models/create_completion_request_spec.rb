...
# Unit tests for OpenAi::CreateCompletionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAi::CreateCompletionRequest do
  let(:instance) { OpenAi::CreateCompletionRequest.new }
  ...
  describe 'test an instance of CreateCompletionRequest' do
    it 'should create an instance of CreateCompletionRequest' do
      ...
      #expect(instance).to be_instance_of(OpenAi::CreateCompletionRequest)
    end
  end
