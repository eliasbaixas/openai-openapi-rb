...
# Unit tests for OpenAi::InviteDeleteResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAi::InviteDeleteResponse do
  let(:instance) { OpenAi::InviteDeleteResponse.new }

  describe 'test an instance of InviteDeleteResponse' do
    it 'should create an instance of InviteDeleteResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenAi::InviteDeleteResponse)
    end
  end
