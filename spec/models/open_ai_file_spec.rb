...
# Unit tests for OpenaiOpenapiRb::OpenAIFile
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenaiOpenapiRb::OpenAIFile do
  let(:instance) { OpenaiOpenapiRb::OpenAIFile.new }

  describe 'test an instance of OpenAIFile' do
    it 'should create an instance of OpenAIFile' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenaiOpenapiRb::OpenAIFile)
    end
  end
