...
# Unit tests for OpenAI::API::CreateCompletionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAI::API::CreateCompletionRequest do
  let(:instance) { OpenAI::API::CreateCompletionRequest.new }
  ...
  describe 'test an instance of CreateCompletionRequest' do
    it 'should create an instance of CreateCompletionRequest' do
      ...
      #expect(instance).to be_instance_of(OpenAI::API::CreateCompletionRequest)
    end
  end
