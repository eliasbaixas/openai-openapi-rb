...
# Unit tests for OpenaiOpenapiRb::CreateImageRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenaiOpenapiRb::CreateImageRequest do
  let(:instance) { OpenaiOpenapiRb::CreateImageRequest.new }

  describe 'test an instance of CreateImageRequest' do
    it 'should create an instance of CreateImageRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenaiOpenapiRb::CreateImageRequest)
    end
  end
