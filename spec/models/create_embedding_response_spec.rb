...
# Unit tests for OpenAi::CreateEmbeddingResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAi::CreateEmbeddingResponse do
  let(:instance) { OpenAi::CreateEmbeddingResponse.new }
  ...
  describe 'test an instance of CreateEmbeddingResponse' do
    it 'should create an instance of CreateEmbeddingResponse' do
      ...
      #expect(instance).to be_instance_of(OpenAi::CreateEmbeddingResponse)
    end
  end
