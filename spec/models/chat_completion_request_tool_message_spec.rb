...
# Unit tests for OpenaiOpenapiRb::ChatCompletionRequestToolMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenaiOpenapiRb::ChatCompletionRequestToolMessage do
  let(:instance) { OpenaiOpenapiRb::ChatCompletionRequestToolMessage.new }
  ...
  describe 'test an instance of ChatCompletionRequestToolMessage' do
    it 'should create an instance of ChatCompletionRequestToolMessage' do
      ...
      #expect(instance).to be_instance_of(OpenaiOpenapiRb::ChatCompletionRequestToolMessage)
    end
  end
