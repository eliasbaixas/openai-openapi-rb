...
# Unit tests for OpenAi::ChatCompletionResponseMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAi::ChatCompletionResponseMessage do
  let(:instance) { OpenAi::ChatCompletionResponseMessage.new }
  ...
  describe 'test an instance of ChatCompletionResponseMessage' do
    it 'should create an instance of ChatCompletionResponseMessage' do
      ...
      #expect(instance).to be_instance_of(OpenAi::ChatCompletionResponseMessage)
    end
  end
