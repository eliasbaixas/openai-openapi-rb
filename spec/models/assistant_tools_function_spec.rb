...
# Unit tests for OpenAI::API::AssistantToolsFunction
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAI::API::AssistantToolsFunction do
  let(:instance) { OpenAI::API::AssistantToolsFunction.new }

  describe 'test an instance of AssistantToolsFunction' do
    it 'should create an instance of AssistantToolsFunction' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenAI::API::AssistantToolsFunction)
    end
  end
