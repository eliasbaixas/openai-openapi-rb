...
# Unit tests for OpenAi::ChatCompletionRequestUserMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAi::ChatCompletionRequestUserMessage do
  let(:instance) { OpenAi::ChatCompletionRequestUserMessage.new }
  ...
  describe 'test an instance of ChatCompletionRequestUserMessage' do
    it 'should create an instance of ChatCompletionRequestUserMessage' do
      ...
      #expect(instance).to be_instance_of(OpenAi::ChatCompletionRequestUserMessage)
    end
  end
