...
# Unit tests for OpenaiOpenapiRb::MessageContentTextAnnotationsFileCitationObject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenaiOpenapiRb::MessageContentTextAnnotationsFileCitationObject do
  let(:instance) { OpenaiOpenapiRb::MessageContentTextAnnotationsFileCitationObject.new }
  ...
  describe 'test an instance of MessageContentTextAnnotationsFileCitationObject' do
    it 'should create an instance of MessageContentTextAnnotationsFileCitationObject' do
      ...
      #expect(instance).to be_instance_of(OpenaiOpenapiRb::MessageContentTextAnnotationsFileCitationObject)
    end
  end
