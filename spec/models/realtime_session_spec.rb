...
# Unit tests for OpenAi::RealtimeSession
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAi::RealtimeSession do
  let(:instance) { OpenAi::RealtimeSession.new }

  describe 'test an instance of RealtimeSession' do
    it 'should create an instance of RealtimeSession' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenAi::RealtimeSession)
    end
  end
