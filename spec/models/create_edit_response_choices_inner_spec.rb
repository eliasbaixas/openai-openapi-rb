...
# Unit tests for OpenAI::API::CreateEditResponseChoicesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAI::API::CreateEditResponseChoicesInner do
  let(:instance) { OpenAI::API::CreateEditResponseChoicesInner.new }
  ...
  describe 'test an instance of CreateEditResponseChoicesInner' do
    it 'should create an instance of CreateEditResponseChoicesInner' do
      ...
      #expect(instance).to be_instance_of(OpenAI::API::CreateEditResponseChoicesInner)
    end
  end
