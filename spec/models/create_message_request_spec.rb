...
# Unit tests for OpenAI::API::CreateMessageRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAI::API::CreateMessageRequest do
  let(:instance) { OpenAI::API::CreateMessageRequest.new }

  describe 'test an instance of CreateMessageRequest' do
    it 'should create an instance of CreateMessageRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenAI::API::CreateMessageRequest)
    end
  end
