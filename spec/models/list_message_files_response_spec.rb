...
# Unit tests for OpenAI::API::ListMessageFilesResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAI::API::ListMessageFilesResponse do
  let(:instance) { OpenAI::API::ListMessageFilesResponse.new }
  ...
  describe 'test an instance of ListMessageFilesResponse' do
    it 'should create an instance of ListMessageFilesResponse' do
      ...
      #expect(instance).to be_instance_of(OpenAI::API::ListMessageFilesResponse)
    end
  end
