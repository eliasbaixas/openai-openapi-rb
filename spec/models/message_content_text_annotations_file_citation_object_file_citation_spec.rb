...
describe OpenAi::MessageContentTextAnnotationsFileCitationObjectFileCitation do
  let(:instance) { OpenAi::MessageContentTextAnnotationsFileCitationObjectFileCitation.new }
