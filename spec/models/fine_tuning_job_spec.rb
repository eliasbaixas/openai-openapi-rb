...
# Unit tests for OpenaiOpenapiRb::FineTuningJob
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenaiOpenapiRb::FineTuningJob do
  let(:instance) { OpenaiOpenapiRb::FineTuningJob.new }

  describe 'test an instance of FineTuningJob' do
    it 'should create an instance of FineTuningJob' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenaiOpenapiRb::FineTuningJob)
    end
  end
