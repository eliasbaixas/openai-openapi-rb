...
# Unit tests for OpenAi::ListMessageFilesResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAi::ListMessageFilesResponse do
  let(:instance) { OpenAi::ListMessageFilesResponse.new }
  ...
  describe 'test an instance of ListMessageFilesResponse' do
    it 'should create an instance of ListMessageFilesResponse' do
      ...
      #expect(instance).to be_instance_of(OpenAi::ListMessageFilesResponse)
    end
  end
