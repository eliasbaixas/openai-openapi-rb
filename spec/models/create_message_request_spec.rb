...
# Unit tests for OpenaiOpenapiRb::CreateMessageRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenaiOpenapiRb::CreateMessageRequest do
  let(:instance) { OpenaiOpenapiRb::CreateMessageRequest.new }

  describe 'test an instance of CreateMessageRequest' do
    it 'should create an instance of CreateMessageRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenaiOpenapiRb::CreateMessageRequest)
    end
  end
