...
# Unit tests for OpenAI::API::FineTuningJobEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAI::API::FineTuningJobEvent do
  let(:instance) { OpenAI::API::FineTuningJobEvent.new }

  describe 'test an instance of FineTuningJobEvent' do
    it 'should create an instance of FineTuningJobEvent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenAI::API::FineTuningJobEvent)
    end
  end
