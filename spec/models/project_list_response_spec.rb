...
# Unit tests for OpenAi::ProjectListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAi::ProjectListResponse do
  let(:instance) { OpenAi::ProjectListResponse.new }

  describe 'test an instance of ProjectListResponse' do
    it 'should create an instance of ProjectListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenAi::ProjectListResponse)
    end
  end
