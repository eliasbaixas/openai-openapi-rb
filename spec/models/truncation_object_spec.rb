...
# Unit tests for OpenAi::TruncationObject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAi::TruncationObject do
  let(:instance) { OpenAi::TruncationObject.new }

  describe 'test an instance of TruncationObject' do
    it 'should create an instance of TruncationObject' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenAi::TruncationObject)
    end
  end
