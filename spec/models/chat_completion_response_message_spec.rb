...
# Unit tests for OpenAI::API::ChatCompletionResponseMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAI::API::ChatCompletionResponseMessage do
  let(:instance) { OpenAI::API::ChatCompletionResponseMessage.new }
  ...
  describe 'test an instance of ChatCompletionResponseMessage' do
    it 'should create an instance of ChatCompletionResponseMessage' do
      ...
      #expect(instance).to be_instance_of(OpenAI::API::ChatCompletionResponseMessage)
    end
  end
